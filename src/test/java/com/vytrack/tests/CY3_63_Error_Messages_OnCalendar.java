...
import com.vytrack.POM_For_US9_63.VyTarckPOM_US9_63;
...
public class CY3_63_Error_Messages_OnCalendar {

    //

    VyTarckPOM_US9_63 VytrackProject;

    @BeforeMethod
    public void setupMethod() {
        Driver.getDriver().get(ConfigurationReader.getProperty("env2"));
        VytrackProject = new VyTarckPOM_US9_63();
    }
